  ...
  background: {
    ...
    local: {
      desktop: [
        ...
        '/images/desktop/background2.jpg',
        '/images/desktop/background3.jpg',
        '/images/desktop/background4.jpg',
        '/images/desktop/background5.jpg',
        '/images/desktop/background6.jpg',
      ],

      mobile: [
        '/images/mobile/background1.jpg',
        '/images/mobile/background2.jpg',
        '/images/mobile/background3.jpg',
        '/images/mobile/background4.jpg',
        '/images/mobile/background5.jpg',
        '/images/mobile/background6.jpg',
      ],
    },
